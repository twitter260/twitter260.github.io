...
This plot represents the average sentiment of the persons tweeting at Donald Trump during the White Lives Matter rally.  Interestingly, the sentiment if higher during the first rally in Shelbyville, and lower when the Murfreesboro rally fails to manifest, which is the opposite of the general trend seen in the plot of all twitter users.
